...
class TestPreamble:
    ...
    async def test_preamble_does_not_break_simple_scripts(
    ...
    async def test_preamble_does_not_pollute_namespace(
        self, executor: PythonExecutor
    ) -> None:
...
"""
    ...
    async def test_preamble_handles_missing_matplotlib(
        self, executor: PythonExecutor
    ) -> None:
    ...
    async def test_preamble_handles_missing_pandas(
        self, executor: PythonExecutor
    ) -> None:
